...
public class Student {
	...
	public Student() {
		...
		//매개변수가 없는 생성자 --> 생략 가능 / 매개변수 있는 생성자 --> 생략 불가능
	}
	...
	public void setName(String name) {
		this.name = name;  //this에는 해당 객체의 주소값이 담겨있다.   필드 name = 매개변수 name;
	}
	...
	//모든 필드값을 다 합친 문자열을 반한하는 메소드
	public String information() {
		String info = "이름 : " + name + ", 나이 : " + age + ", 키" + height + ", 국어점수 : " + kor + ", 수학점수 : " + math;
		return info;
	}
}

package com.kh.chap01_Abstraction.model.run;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		//만약에 변수만을 가지고 프로그램에 필요한 객체를 만들어낸다고 했을 때
		String name1 = "유산슬";
		int age1 = 20;
		int kor1 = 80;
		int math1 = 90;
		...
		//1. 클래스를 만들고 나서 자바의 객체 형태로 만들기 위해서는 new연산자를 통해서 heap영역에 생성을 해야한다.(즉, 공간할당)
		Student u = new Student();  //->객체 생성 : new연산자를 통해 heap영역에 공간이 만들어졌다.
		...
		//public으로 접근해서 바깥에서 맘대로 접근, 조회, 수정하면 안됨
		
		/* 외부에서 직접 접근을 통해 값을 변경할 수도 있다 -> 안됨
		 * 즉, public 으로 작업을 하게되면 외부에서 직접 접근을 통해서 값이 변질되거나 마음대로 조회할 수 있다.
		 * 
		 * --> 캡슐화 작업을 해야한다.
		 * --> 객체지향 설계원칙중에 정보은닉 기술 중 일부분이 캡슐화라는 것이다.
		 * 
		 * 
		 * */

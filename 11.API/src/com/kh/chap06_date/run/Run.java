package com.kh.chap06_date.run;
...
public class Run {
	...
	/*
	 * 1. Date (java.util 패키지) - Date는 날짜를 다루기 위해 제공되는 클래스 - 자바개발 초기에 급하게 만들어서 완성도도
	 * 낮고, 다국적으로 쓰기도 적합하지 않음 - 1970년 1월 1일 0시 0분 0초를 기준으로 milliseconds 단위로 계산함 -
	...
	public static void main(String[] args) {
		...
		/*
		 * @Deprecated : 언제 없어질지 모름 / 안쓰는 것을 권장 public Date(int year, int month, int
		 * date)
		 * 

package com.sy.example.objectArray.hw1.run;

import com.sy.example.objectArray.hw1.Employee;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<3; i++) {
			String name = emp[i].getEmpName();
			int sal = emp[i].getSalary();
			int money = (int)(sal + sal*emp[i].getBonusPoint())*12;

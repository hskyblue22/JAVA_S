package com.sy.example.collection.view;

import java.util.Scanner;

import com.sy.example.collection.controller.BoardManger;

public class BoardMenu {
	private Scanner sc = new Scanner(System.in);
	private BoardManger bm = new BoardManger();
	...
	public void mainMenu() {
		while(true) {
			...
			case 1:
				bm.writeBoard(); break;
			case 2:
				bm.displayAllList(); break;
			case 3:
				bm.displayBoard(); break;
			case 4:
				bm.modifyTitle(); break;
			case 5:
				bm.modifyContent(); break;
			case 6:
				bm.deleteBoard(); break;
			case 7:
				bm.searchBoard(); break;
			case 8:
				bm.saveListFile(); break;
			case 9:
				sortSubMenu(); break;
			case 10:

...
public class F_Keyboardinput {
	...
	public void inputScanner2() {
		...
		System.out.println(name + "님은 " + age + "세이며, 사는 곳은 " + address + "이고, 키는 " + height + "cm입니다.");
		System.out.printf("%s님은 %d세이며, 사는 곳은 %s이고, 키는 %.2fcm입니다.\n", name, age, address, height);
	}
	...
	public void inputScanner3() {
		...
		//sc.nextChar(); --> 존재하지 않는다. charAt : 문자열에서 지정된 위치에 있는 문자 하나만 뽑아내는 기능을 함. // 이때 위치는 0부터 시작해서 1씩 증가

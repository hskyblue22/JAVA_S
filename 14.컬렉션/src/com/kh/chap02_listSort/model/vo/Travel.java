...
//implements Comparable -> compareTo오버라이드 해야한다.
	...
	//---------------------------------tNum 오름차순, 내림차순(2가지)
	//implements Comparable적은 후 compareTo 오버라이딩
	/*@Override
	...
	@Override
	public int compareTo(Object o) {  //내림차순 2가지 방법
		// TODO Auto-generated method stub
	...
	public int compareTo(Travel o) {
		// TODO Auto-generated method stub
		System.out.println("this : "+ (this.country) + "Object : "+ (((Travel)o).country) + " return : "+ country.compareTo(((Travel)o).country));
		return this.country.compareTo(o.country);  //this.country로 해도 되고 country로 해도 정렬되네
	} */
